...
export class CreateTable1737022746452 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rss" ("data" json, "link" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_52b0451245f4b73ae3d488ffb5e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "rss_data" ("link" character varying NOT NULL, "data" json NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "rssId" uuid NOT NULL, CONSTRAINT "PK_41814b746c4cc029bd9a0eceacd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "rss_data" ADD CONSTRAINT "FK_7ca4683f0e935b861d563afc778" FOREIGN KEY ("rssId") REFERENCES "rss"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "rss_data" DROP CONSTRAINT "FK_7ca4683f0e935b861d563afc778"`);
